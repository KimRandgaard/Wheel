...
class GameActivity : AppCompatActivity() {
    ...
    private val gameManager = GameViewModel()
    ...
    private fun updateUI(gameState: GameState) {
        when (gameState) {
            ...
            is GameState.Won -> showGameWon(gameState.wodToGuess)
        }
    }
    ...
    private fun showGameLost(wordToGuess: String) {
        ...
        imageView.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.life5))
